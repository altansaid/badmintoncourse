...
const Registration = () => {
  const handleRegisterClick = () => {
    window.open("https://docs.google.com/forms/d/1a2lvtTf6RDRoW9Qb0VUqkJLtgfOYZ7FunAUAM64Izq0/viewform", "_blank");
  };
      ...
      <div className="max-w-4xl mx-auto text-center">
        <div className="mb-16 animate-slide-up">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Take the first step towards your badminton journey. Register now and join 
            our free program led by professional coaches!
          </p>
        </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center">
              <Button 
                ...
                className="gradient-accent text-accent-foreground hover:scale-105 transition-bounce px-12 py-6 text-lg font-semibold shadow-glow"
              >
